...
whitelist legitimate use of these APIs, they can break more than 86\% of existing shell codes on 10 Windows applications in their dataset and all stop ROP exploits for 8/10 applications.
